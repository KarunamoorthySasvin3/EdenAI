...
export function PlantRecommendations({ className }: PlantRecommendationsProps) {
  const plants = [
    {
      id: "lavender",
      name: "Lavender",
      latinName: "Lavandula angustifolia",
      description: "Drought-tolerant perennial with fragrant purple flowers that attract pollinators.",
    ...
    },
    {
      ...
      description: "Productive shrub that provides delicious berries and beautiful fall foliage.",
    ...
    },
    {
      ...
      description: "Native evergreen fern that thrives in shady, moist conditions.",
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>AI-powered suggestions for your garden</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          {plants.map((plant) => (
            <TabsContent key={plant.id} value={plant.id} className="space-y-4">
              <div className="aspect-video relative rounded-lg overflow-hidden">
                <img src={plant.image || "/placeholder.svg"} alt={plant.name} className="object-cover w-full h-full" />
              </div>
              <div>
