...
export function OnboardingStepTwo({
  ...
  // Example for any component with initial values
  const [value, setValue] = useState("default-value"); // Instead of useState("")
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Different plants thrive in different soil types. Don't worry if
